...
public class atm1 {
    ...
    static void with(int kk){
        if(kk/2000!=0){
            arr1[0]=kk/2000;//quationt
            kk=kk%2000;//remainder
        }
        if(kk/500!=0){
            arr1[1]=kk/500;
            kk=kk%500;
    ...
    public void admin(){
        ...
        do{
            System.out.print("\033[H\033[2J");
            System.out.flush();System.out.println("****Welcome Admin****");
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            switch(x){
                ...
                int pass=sc.nextInt();
                if((username).equals("EZHIL")&& (pass==1234)){
                    op.admin();
                }
                ...
                for(int i=3;i>=0;i--){
                    ...
                    if((username1).equals("EZHIL")&& (pass1==fass)){
                        op.customer();
                        break;
                    }
